...
namespace Hata.Migrations
{
    ...
    [Migration("20211017173729_updateEntities_1")]
            ...
            modelBuilder.Entity("Hata.Entities.Image", b =>
                {
                    ...
                    b.Property<bool>("IsPrivatePhoto")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Hata.Entities.Image", b =>
                {
                    ...
                    b.HasOne("Hata.Entities.User", "User")
                        .WithOne("Image")
                        .HasForeignKey("Hata.Entities.Image", "UserId");
            ...
            modelBuilder.Entity("Hata.Entities.LocationPoints", b =>
                {
                    b.HasOne("Hata.Entities.Announcement", "Announcement")
                        .WithOne("Location")
                        .HasForeignKey("Hata.Entities.LocationPoints", "AnnouncementId");

                    b.HasOne("Hata.Entities.User", "User")
                        .WithOne("Location")
                        .HasForeignKey("Hata.Entities.LocationPoints", "UserId");
